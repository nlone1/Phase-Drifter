...
class level1_scene extends Phaser.Scene {
    ...
    create() {
        ...
        doorTrigger.create(82, 505, 'doorTrigger');
        ...
        // DoorTrigger collision which triggers nextLevel() function
        this.physics.add.overlap(player, doorTrigger, goLevel2, null, this);
